    ...
    <>
      ...
      <div className="w-full">
        <div className="flex items-center h-16 px-4">
          ...
          <div className="flex items-center space-x-2 justify-end flex-shrink-0 ml-auto" style={{ width: '520px' }}>

            {/* Dynamic content area - controlled width */}
            <div className="flex items-center justify-start" style={{ width: '280px' }}>
              ...
              {location.pathname === '/admin' && (
                <div className="flex items-center space-x-2">
                  ...
                  <div className="flex items-center space-x-1 bg-yellow-50 px-2 py-1 rounded text-xs">
                    ...
                    <span className="text-yellow-700 font-medium">3 Tasks</span>
                  </div>
                </div>
              )}

              {/* Other Pages - Minimal Branding */}
              {!['dashboard', 'analytics', 'admin'].includes(location.pathname.replace('/', '')) && (
              ...
              {isProfileMenuOpen && (
                ...
                >
                  <div className="px-4 py-3 border-b border-gray-200">
                    ...
                    <div className="mt-2 pt-2 border-t border-gray-100 space-y-1">
                      ...
                      <div className="flex items-center text-xs text-gray-400">
                        ...
                        <span>Last login: {user?.lastLogin ?
                  ...
                  <div className="px-3 py-2 bg-blue-50 border-l-2 border-blue-200">
                    <div className="text-xs font-medium text-blue-700 mb-1">🗺️ Map Preferences</div>
                  ...
                  <div className="px-3 py-2">
                    <div className="text-xs font-medium text-gray-700 mb-1">⚡ Quick Access</div>
                  ...
                  <div className="px-3 py-2 bg-green-50 border-l-2 border-green-200">
                    <div className="text-xs font-medium text-green-700 mb-1">🔒 Security</div>
                    <div className="space-y-0.5">
                      <div className="flex items-center justify-between text-xs text-gray-600">
                        <span>Sessions:</span>
                        <span className="text-green-600 font-medium">2 devices</span>
                      </div>
                      <div className="flex items-center justify-between text-xs text-gray-600">
                        <span>Login IP:</span>
                  ...
                  {/* Help Section */}
                  <div className="px-3 py-2">
                    <div className="text-xs font-medium text-gray-700 mb-1">❓ Help</div>
                    <div className="space-y-0.5">
                      <button className="flex items-center w-full text-xs text-gray-600 hover:text-gray-800 py-0.5">
                        <span className="mr-2">⌨️</span>
                        <span>Shortcuts</span>
                        <span className="ml-auto text-gray-400 text-xs">Ctrl+?</span>
                      </button>
                      <button className="flex items-center w-full text-xs text-gray-600 hover:text-gray-800 py-0.5">
